...
#
#   workflow-xslt
#   A generic XSLT based job generator for Beaker
#
#   This module uses XSLT templates to generate Beaker job XML files.
#   The XML input for the XSLT is generated by this program based on
#   a configuration file which defines required and optional parameters.
#
