...
class SystemFilteringTest(DatabaseTestCase):
    ...
    def check_filter(self, filterxml, present=[], absent=[]):
        ...
        if present:
            self.assertItemsEqual(
                present, query.filter(System.id.in_([s.id for s in present])).all()
            )
        if absent:
            self.assertItemsEqual(
    ...
    def test_system_added(self):
        ...
        self.check_filter(
            ...
            """
            % date_today,
            present=[sys_tomorrow],
            absent=[sys_today1, sys_today2],
        )
    ...
    def test_key_equal(self):
        ...
        without_cciss.key_values_string.extend(
            [Key_Value_String(module_key, u"ida"), Key_Value_String(module_key, u"kvm")]
        )
        self.check_filter(
            """
            <hostRequires>
    ...
    def test_filtering_by_device(self):
        ...
        with_e1000.devices.append(
            data_setup.create_device(
                device_class_id=network_class.id,
                vendor_id=u"8086",
                device_id=u"107c",
                subsys_vendor_id=u"8086",
                subsys_device_id=u"1376",
                bus=u"pci",
                driver=u"e1000",
        ...
        with_tg3.devices.append(
            data_setup.create_device(
                device_class_id=network_class.id,
                vendor_id=u"14e4",
                device_id=u"1645",
                subsys_vendor_id=u"10a9",
                subsys_device_id=u"8010",
                bus=u"pci",
                driver=u"tg3",
    ...
    def test_filtering_by_disk(self):
        ...
        big_512e_disk.disks[:] = [
            Disk(size=2000000000000, sector_size=512, phys_sector_size=4096)
        ]
        ...
        self.check_filter(
            ...
            """,
            present=[big_disk, big_512e_disk],
            absent=[small_disk, two_disks],
        )
        ...
        self.check_filter(
            ...
            """,
            present=[big_disk, big_512e_disk, two_disks],
            absent=[small_disk],
        )
        ...
        self.check_filter(
            ...
            """,
            present=[small_disk, big_512e_disk],
            absent=[big_disk, two_disks],
        )
        ...
        self.check_filter(
            ...
            """,
            present=[small_disk, two_disks, big_512e_disk],
            absent=[big_disk],
        )
        ...
        self.check_filter(
            ...
            """,
            present=[big_disk, two_disks],
            absent=[small_disk, big_512e_disk],
        )
        ...
        self.check_filter(
            ...
            """,
            present=[small_disk, big_512e_disk, two_disks],
            absent=[big_disk],
        )
    ...
    def test_filtering_by_diskcount(self):
        ...
        three_disks.disks[:] = [
            Disk(size=400000000000, sector_size=4096, phys_sector_size=4096),
    ...
    def test_compatible_with_distro(self):
        distro_tree = data_setup.create_distro_tree(
            arch=u"ppc64le", osmajor=u"RedHatEnterpriseLinux7", osminor=u"4"
        )
        excluded_osmajor = data_setup.create_system(
            arch=u"ppc64le", exclude_osmajor=[distro_tree.distro.osversion.osmajor]
        )
        excluded_osversion = data_setup.create_system(
            arch=u"ppc64le", exclude_osversion=[distro_tree.distro.osversion]
        )
...
class OpenstackFlavorFilteringTest(DatabaseTestCase):
    ...
    def check_filter(self, filterxml, lab_controller=None, present=[], absent=[]):
        ...
        matched_flavors = XmlHost.from_string(filterxml).filter_openstack_flavors(
            present + absent, lab_controller
        )
    ...
    def test_flavors_with_no_disk_are_always_excluded(self):
        ...
        self.check_filter("<hostRequires/>", present=[some_disk], absent=[no_disk])
    ...
    def test_all_flavors_excluded_by_default(self):
        ...
        self.check_filter(
            ...
            """,
            present=[],
            absent=[FakeFlavor(disk=10, ram=512, vcpus=1)],
        )
    ...
    def test_or(self):
        ...
        self.check_filter(
            ...
            """,
            present=[small_flavor, large_flavor],
            absent=[medium_flavor],
        )
    ...
    def test_and(self):
        ...
        self.check_filter(
            ...
            """,
            present=[small_flavor],
            absent=[medium_flavor, large_flavor],
        )
