...
class SystemQuickUsageTest(WebDriverTestCase):
    ...
    def test_action_buttons(self):
        ...
        self.assertEqual(self.action_button_labels(), ['Request Loan'])
        self.go_to_system_view(borrowable_but_loaned)
        self.assertEqual(self.action_button_labels(), ['Schedule Reservation'])
        self.go_to_system_view(borrowable)
        self.assertEqual(self.action_button_labels(), ['Borrow'])
        self.go_to_system_view(borrowed)
        self.assertEqual(self.action_button_labels(), ['Take', 'Return Loan'])
        self.go_to_system_view(stealable)
        self.assertEqual(self.action_button_labels(), ['Return Loan'])
        self.go_to_system_view(manual)
        self.assertEqual(self.action_button_labels(), ['Take'])
        self.go_to_system_view(taken)
        self.assertEqual(self.action_button_labels(), ['Return'])
