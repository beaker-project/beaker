...
insert into log_recipe_task (id, recipe_task_id, path, filename, start_time)
VALUES (1, 1, '/', 'test_log1', '2016-02-06 00:00:00');
insert into log_recipe (id, recipe_id, path, filename, start_time)
VALUES (1, 1, '/', 'test_log1', '2016-02-06 00:00:00');
...
insert into log_recipe_task (id, recipe_task_id, path, filename, start_time)
VALUES (2, 2, '/', 'test_log1', '2016-02-06 00:00:00');
insert into log_recipe (id, recipe_id, path, filename, start_time)
VALUES (2, 2, '/', 'test_log1', '2016-02-06 00:00:00');
