...
_compose_test_dir = pkg_resources.resource_filename(
...
if os.path.exists(os.path.join(_git_root_dir, ".git")):
    ...
    _command = os.path.join(
        _git_root_dir, "LabController/src/bkr/labcontroller/distro_import.py"
    )
else:
...
class DistroImportTest(LabControllerTestCase):
    ...
    def setUp(self):
        self.x86_64_rhel5 = {
            u"osmajor": u"RedHatEnterpriseLinuxServer5",
            ...
            u"repos": [
                {u"path": u"VT", u"type": u"addon", u"repoid": u"VT"},
                {u"path": u"Server", u"type": u"addon", u"repoid": u"Server"},
                {u"path": u"Cluster", u"type": u"addon", u"repoid": u"Cluster"},
                {
                    u"path": u"ClusterStorage",
                    u"type": u"addon",
                    u"repoid": u"ClusterStorage",
                },
                {u"path": u"../debug", u"type": u"debug", u"repoid": u"debuginfo"},
            ],
            u"variant": u"",
        ...
        self.x86_64_rhel7_alpha3_compose = {
            u"arch": u"x86_64",
            u"arches": [],
            u"images": [
                {u"path": u"images/pxeboot/vmlinuz", u"type": u"kernel"},
            ...
            u"urls": [
                u"http://localhost:19998/RHEL7Alpha3/Workstation/x86_64/os/",
        ...
        self.s390x_rhel7_alpha3_compose = {
            u"arch": u"s390x",
            u"arches": [],
            u"images": [
                {u"path": u"images/kernel.img", u"type": u"kernel"},
            ...
            u"urls": [
                u"http://localhost:19998/RHEL7Alpha3/Server/s390x/os/",
        ...
        self.ppc64_rhel7_alpha3_compose = {
            u"arch": u"ppc64",
            u"arches": [],
            u"images": [
                {u"path": u"ppc/ppc64/vmlinuz", u"type": u"kernel"},
            ...
            u"urls": [
                u"http://localhost:19998/RHEL7Alpha3/Server/ppc64/os/",
        ...
        self.x86_64_rhel7_client_compose = {
            ...
            u"repos": [
                {
                    u"path": u"../../../Client-optional/x86_64/os",
        ...
        self.x86_64_rhel7_computenode_compose = {
            ...
            u"repos": [
                {
                    u"path": u"../../../ComputeNode-optional/x86_64/os",
        ...
        self.x86_64_rhel7_server_compose = {
            ...
            u"repos": [
                {
                    u"path": u"addons/HighAvailability",
                    u"repoid": u"HighAvailability",
                    u"type": u"addon",
                },
                {
        ...
        self.i386_f18 = {
            ...
            u"arches": [],
            u"urls": [
                u"http://localhost:19998/F-18/GOLD/Fedora/i386/os/",
        ...
        self.i386_fedora_rawhide = {
            u"osmajor": u"Fedorarawhide",
            ...
            u"kernel_options_post": None,
            u"repos": [
                {u"path": u".", u"type": u"variant", u"repoid": u"Fedora"},
                {
                    u"path": u"../../i386/debug",
                    u"type": u"debug",
                    u"repoid": u"Fedora-debuginfo",
        ...
        self.armhfp_fedora_rawhide = {
            ...
            u"images": [
                {u"path": u"images/pxeboot/vmlinuz", u"type": u"kernel"},
                {u"path": u"images/pxeboot/initrd.img", u"type": u"initrd"},
                {u"path": u"images/pxeboot/uImage", u"type": u"uimage"},
                {u"path": u"images/pxeboot/uInitrd", u"type": u"uinitrd"},
            ],
            u"arches": [],
            u"arches": [],
        ...
        self.x86_64_rhel6_naked = {
            u"arch": u"x86_64",
            u"arches": [u"x86_64"],
            u"images": [
                {
                    u"path": u"/RHEL-6-Server-RHEV/6.4/6.4.1.1/vmlinuz0",
                    u"type": u"kernel",
                },
                {
        ...
        self.x86_64_rhel8 = {
            ...
            u"urls": [
                u"http://localhost:19998/RHEL8Alpha/RHT/8.0-Alpha/BaseOS/x86_64/os/"
            ],
            u"variant": u"BaseOS",
        }
        ...
        self.x86_64_rhel8_unified_partner_compose = {
            ...
            u"tree_build_time": u"1523757763",
            u"urls": [
                u"http://localhost:19998/RHEL8Alpha/Unified/RHEL-8.0-20180531.2/compose/BaseOS/x86_64/os/"
            ],
            u"variant": u"BaseOS",
        }
        ...
        self.x86_64_rhel8_partner = {
            ...
            u"tree_build_time": u"1523757763",
            u"urls": [
                u"http://localhost:19998/RHEL8Alpha/Partners/RHEL-8.0-20180531.2/compose/BaseOS/x86_64/os/"
            ],
            u"variant": u"BaseOS",
        }
        ...
        self.x86_64_rhvh43 = {
            ...
            u"kernel_options": u" inst.stage2={}".format(
                urlparse.urljoin(
            ...
            u"tags": [u"RC-20200323.0"],
            u"tree_build_time": u"1584961599",
            u"urls": [
                u"{}".format(
                    urlparse.urljoin(
                        self.distro_url,
                        u"RHVH4/RHVH-4.3-20200323.0/compose/RHVH/x86_64/os/",
                    )
                )
            ],
            u"variant": u"RHVH",
    ...
    def import_trees(self, additional_import_args):
        trees, stderr = self._run_import(
            ["python", _command, "--debug", "--json"] + additional_import_args
        )
        # check logging is working correctly
        self.assertIn("Attempting to import: ", stderr)
        # return dumped JSON tree info
    ...
    def test_invalid_arch(self):
        rhel7_trees = self.dry_run_import_trees(
            ["--arch", "i386", "--arch", "x86_64", "%sRHEL7Alpha3/" % self.distro_url]
        )
        self.assertEquals(len(rhel7_trees), 4)

        f18_trees = self.dry_run_import_trees(
            [
                "--arch",
                "CISC",
                "--arch",
        ...
        rhel6_trees = self.dry_run_import_trees(
            ["--arch", "AVR", "--arch", "x86_64", "%sRHEL6-Server/" % self.distro_url]
        )
        self.assertEquals(len(rhel6_trees), 1)

        rhel5_trees = self.dry_run_import_trees(
            ["--arch", "RISC", "--arch", "x86_64", "%sRHEL5-Server/" % self.distro_url]
        )
    ...
    def test_rhel6_naked_import(self):
        trees = self.dry_run_import_trees(
            [
                "%sRHEL-6-Server-RHEV/6.4/6.4.1.1/" % self.distro_url,
                "--name",
                "RHEVH-6.4-20130318.1",
                "--family",
                "RHEVH",
                "--variant",
                "Server",
                ...
                "6.4",
                "--kernel",
                "/RHEL-6-Server-RHEV/6.4/6.4.1.1/vmlinuz0",
                "--initrd",
    ...
    def test_rhel5_tree_import_tree(self):
        trees = self.dry_run_import_trees(["%sRHEL5-Server/i386/os/" % self.distro_url])
    ...
    def test_rhel5_tree_import_tree_with_iso(self):
        trees = self.dry_run_import_trees(
            [
                "%sRHEL5-Server/i386/os/" % self.distro_url,
                "nfs://fake.example.com:/nfs/RHEL5-Server/i386/os/",
            ]
        )
        self.assertEquals(len(trees), 1)
        tree = trees.pop()
    ...
    def test_f17_tree_import_i386(self):
        ...
        trees = self.dry_run_import_trees(
            ["%sF-17/GOLD/Fedora/i386/os" % self.distro_url]
        )
    ...
    def test_f17_tree_import_x86_64(self):
        ...
        trees = self.dry_run_import_trees(
            ["%sF-17/GOLD/Fedora/x86_64/os" % self.distro_url]
        )
    ...
    def test_f18_tree_import_x86_64(self):
        ...
        trees = self.dry_run_import_trees(
            ["%sF-18/GOLD/Fedora/x86_64/os" % self.distro_url]
        )
    ...
    def test_fedora_rawhide_tree_import_i386(self):
        ...
        trees = self.dry_run_import_trees(
            ["%sFedora-rawhide/i386/os" % self.distro_url]
        )
    ...
    def test_fedora_rawhide_tree_import_x86_64(self):
        ...
        trees = self.dry_run_import_trees(
            ["%sFedora-rawhide/x86_64/os" % self.distro_url]
        )
        expected_tree = self._rawhide_treeinfo(
    ...
    def test_fedora_rawhide_tree_import_armhfp(self):
        ...
        trees = self.dry_run_import_trees(
            ["%sFedora-rawhide/armhfp/os" % self.distro_url]
        )
        expected_tree = self._rawhide_treeinfo(
    ...
    def test_centos7_tree_import_x86_64(self):
        trees = self.dry_run_import_trees(
            ["%scentos/7.0.1406/os/x86_64" % self.distro_url]
        )
    ...
    def test_selective_compose_import(self):
        trees = self.dry_run_import_trees(
            ["--arch", "i386", "%sRHEL6-Server/" % self.distro_url]
        )
    ...
    def test_incomplete_compose(self):
        ...
        trees = self.dry_run_import_trees(
            ["%sRHEL-6.6-incomplete" % self.distro_url, "--ignore-missing-tree-compose"]
        )
    ...
    def test_cannot_import_osmajor_existing_alias(self):
        ...
        try:
            trees = self.import_trees(
                ["--family", u"RHEL", "%sRHEL6-Server/" % self.distro_url]
            )
            self.fail("Must fail or die")
        except TreeImportError as e:
            self.assert_(
                "Cannot import distro as RHEL6: "
                "it is configured as an alias for RedHatEnterpriseLinux6"
                in e.stderr_output,
                e.stderr_output,
            )
    ...
    def test_rhel8_unified_partner_import(self):
        trees = self.dry_run_import_trees(
            ["%sRHEL8Alpha/Unified/RHEL-8.0-20180531.2/compose" % self.distro_url]
        )
        self.assertItemsEqual(trees, [self.x86_64_rhel8_unified_partner_compose])

    def test_rhel8_partner_import(self):
        trees = self.dry_run_import_trees(
            ["%sRHEL8Alpha/Partners/RHEL-8.0-20180531.2/compose" % self.distro_url]
        )
    ...
    def test_rhvh43_import(self):
        trees = self.dry_run_import_trees(
            [
                "{}".format(
                    urlparse.urljoin(
                        self.distro_url, "RHVH4/RHVH-4.3-20200323.0/compose"
                    )
                )
            ]
        )
