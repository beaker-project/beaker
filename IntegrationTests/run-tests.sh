...
if [[ -z ${BKR_PY3} ]] || [[ ${BKR_PY3} != 1 ]]; then
    # pkg_resources.requires() does not work if multiple versions are installed
    # in parallel. This semi-supported hack using __requires__ is the workaround.
