...
extensions = ['beakerext', 'sphinx.ext.autodoc', 'sphinx.ext.intersphinx', 'sphinx.ext.todo', 'sphinx.ext.viewcode']
...
man_pages = [
    ('index', 'beaker', u'Beaker Documentation',
     [u'Red Hat, Inc.'], 1)
]
