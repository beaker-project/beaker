...
class SystemAction(object):
    ...
    def report_system_problem(
        self, system, description, recipe_id=None, tg_errors=None, **kw
    ):
        if tg_errors:
        ...
        if recipe_id is not None:
            ...
            recipe = None
        mail.system_problem_report(system, description, recipe, identity.current.user)
