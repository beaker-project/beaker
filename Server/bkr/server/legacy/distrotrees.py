...
from bkr.server.model import session, DistroTree, Distro, OSVersion, \
        LabController, LabControllerDistroTree, DistroTreeActivity, Arch
...
from bkr.server.rpc.distrotrees import DistroTrees as DistroTreesRPC

__all__ = ['DistroTrees']

class DistroTrees(RPCRoot, DistroTreesRPC):
