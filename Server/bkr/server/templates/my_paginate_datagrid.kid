<div xmlns:py="http://purl.org/kid/ns#">
  <div class="pagination pagination-right">
    ...
    <ul>
      <span py:if="tg.paginate.href_prev" py:strip="True">
        <li><a href="${tg.paginate.href_first}">&lt;&lt;</a></li>
        <li><a href="${tg.paginate.href_prev}">&lt;</a></li>
      </span>
      <span py:if="tg.paginate.page_count > 1" py:for="page in tg.paginate.pages" py:strip="True">
      ...
      <span py:if="tg.paginate.href_next" py:strip="True">
        <li><a href="${tg.paginate.href_next}">&gt;</a></li>
        <li><a href="${tg.paginate.href_last}">&gt;&gt;</a></li>
      </span>
    </ul>
  </div>
