...
import tempfile
import unittest
from bkr.server.testinfo import (
    get_namespace_for_package,
    parse_string,
    TestInfo,
    StrictParser,
    ParserError,
...
class DescriptionFieldTests(unittest.TestCase):
    def test_description(self):
        ...
        self.assertEquals(
            ti.test_description, u"Ensure that the thingummy frobnicates the doohickey"
        )

    def test_description_with_colon(self):
        "Ensure Description field containing a colon is parsed correctly"
        ti = parse_string(
            u"Description: This test is from http://foo/bar", raise_errors=False
        )
...
class RhtsOptionsFieldTests(unittest.TestCase):
    ...
    def test_multi_options(self):
        "Ensure RhtsOptions field is parsed correctly"
        ti = parse_string(
            u"RhtsOptions: Compatible -CompatService -StrongerAVC", raise_errors=False
        )
        self.assertEquals(
            ti.options, [u"Compatible", u"-CompatService", u"-StrongerAVC"]
        )
    ...
    def test_rhtsoption_bad_value(self):
        ...
        self.assertRaises(
            ParserError, parse_string, u"RhtsOptions: Compat", raise_errors=True
        )
...
class EnvironmentFieldTests(unittest.TestCase):
    ...
    def test_environment_duplicate_key(self):
        ...
        self.assertRaises(
            ParserError,
            parse_string,
            u"Environment: VAR1=VAL1\nEnvironment: VAR1=Value with spaces - 2",
            raise_errors=True,
        )
    ...
    def test_environment_bad_key(self):
        ...
        self.assertRaises(
            ParserError, parse_string, u"Environment: VAR =VAL1", raise_errors=True
        )
...
class NotifyFieldTests(unittest.TestCase):
    def test_notify(self):
        ...
        self.assertRaises(
            ParserWarning,
            parse_string,
            u"Notify: everyone in a 5-mile radius",
            raise_errors=True,
        )
...
class OwnerFieldTests(unittest.TestCase):
    ...
    def test_owner_example2(self):
        ...
        ti = parse_string(
            u"Owner: Jane Doe <jdoe@fedoraproject.org>", raise_errors=False
        )
...
class NeedPropertyFieldTests(unittest.TestCase):
    ...
    def test_multiline_needproperty(self):
        ...
        self.assertEquals(
            ti.need_properties, [(u"CAKE", u"=", u"CHOCOLATE"), (u"SLICES", u">", u"3")]
        )
...
class SiteConfigDeclarationTests(unittest.TestCase):
    ...
    def test_relative_siteconfig_without_name(self):
        ...
        self.assertRaises(
            ParserError,
            parse_string,
            u"SiteConfig(server): Hostname of server",
            raise_errors=True,
        )
    ...
    def test_siteconfig_whitespace(self):
        ...
        ti = parse_string(
            u"SiteConfig(/foo/bar):        Some value    ", raise_errors=False
        )
    ...
    def test_output_relative_siteconfig(self):
        ...
        self.assertEquals(
            ti.generate_siteconfig_lines(), u"SiteConfig(baz/fubar): Dummy value\n"
        )
...
SiteConfig(/stable-servers/ldap/hostname): Location of stable LDAP server to use
        ...
        self.assertEquals(
            ti2.test_path, u"/mnt/tests/examples/coreutils/example-simple-test"
        )
        self.assertEquals(
        ...
        self.assertEquals(
            ti2.need_properties,
            [(u"CAKE", u"=", u"CHOCOLATE"), (u"SLICES", u">", u"3")],
        )
        self.assertEquals(
            ti2.siteconfig,
            [
