...
class LuceneQueryTest(unittest.TestCase):
    def assert_clause_equals(self, actual, expected):
        ...
        if (
            str(actual_compiled) != str(expected_compiled)
            or actual_compiled.params != expected_compiled.params
        ):
            self.fail(
                "SQLAlchemy clauses do not match\nActual: %s %s\nExpected: %s %s"
                % (
                    actual_compiled,
                    actual_compiled.params,
                    expected_compiled,
    ...
    def test_single_term(self):
        clause = lucene_to_sqlalchemy(
            u"user_name:rmancy", {"user_name": User.user_name}, [User.user_name]
        )
    ...
    def test_multiple_terms(self):
        ...
        self.assert_clause_equals(
            clause,
            and_(
                User.user_name == u"rmancy", User.email_address == u"rmancy@redhat.com"
            ),
        )

    def test_quoted_term(self):
        clause = lucene_to_sqlalchemy(
            u'display_name:"Raymond Mancy"',
    ...
    def test_default_field(self):
        ...
        self.assert_clause_equals(
            clause,
            or_(User.user_name.like(u"rmancy%"), User.email_address.like(u"rmancy%")),
        )
    ...
    def test_datetime_column(self):
        ...
        self.assert_clause_equals(
            clause,
            and_(
                System.date_added >= datetime.datetime(2014, 9, 8, 0, 0),
                System.date_added <= datetime.datetime(2014, 9, 8, 23, 59, 59),
            ),
        )
        # searching invalid dates against a datetime column is just False
        clause = lucene_to_sqlalchemy(
            u"date_added:fnord", {"date_added": System.date_added}, [System.date_added]
        )
        self.assert_clause_equals(clause, and_(false()))

    def test_integer_range(self):
        clause = lucene_to_sqlalchemy(
            u"memory:[1024 TO 2048]", {"memory": System.memory}, [System.memory]
        )
        self.assert_clause_equals(
            clause, and_(System.memory >= 1024, System.memory <= 2048)
        )
        clause = lucene_to_sqlalchemy(
            u"memory:[1024 TO *]", {"memory": System.memory}, [System.memory]
        )
        self.assert_clause_equals(clause, and_(System.memory >= 1024, true()))
        clause = lucene_to_sqlalchemy(
            u"memory:[* TO 2048]", {"memory": System.memory}, [System.memory]
        )
        self.assert_clause_equals(clause, and_(true(), System.memory <= 2048))
        clause = lucene_to_sqlalchemy(
            u"memory:[* TO *]", {"memory": System.memory}, [System.memory]
        )
        self.assert_clause_equals(clause, and_(true(), true()))
        clause = lucene_to_sqlalchemy(
            u"memory:[fnord TO blorch]", {"memory": System.memory}, [System.memory]
        )
    ...
    def test_datetime_range(self):
        clause = lucene_to_sqlalchemy(
            u"date_added:[2014-08-01 TO 2014-08-31]",
            {"date_added": System.date_added},
            [System.date_added],
        )
        self.assert_clause_equals(
        ...
        clause = lucene_to_sqlalchemy(
            u"date_added:[2014-08-01 TO *]",
            {"date_added": System.date_added},
            [System.date_added],
        )
        self.assert_clause_equals(
            clause,
            and_(System.date_added >= datetime.datetime(2014, 8, 1, 0, 0), true()),
        )
        clause = lucene_to_sqlalchemy(
            u"date_added:[* TO 2014-08-31]",
            {"date_added": System.date_added},
            [System.date_added],
        )
        self.assert_clause_equals(
            clause,
            and_(
                true(), System.date_added <= datetime.datetime(2014, 8, 31, 23, 59, 59)
            ),
        )
        clause = lucene_to_sqlalchemy(
            u"date_added:[* TO *]",
    ...
    def test_string_range(self):
        clause = lucene_to_sqlalchemy(
            u"fqdn:[aaa TO zzz]", {"fqdn": System.fqdn}, [System.fqdn]
        )
        self.assert_clause_equals(
            clause, and_(System.fqdn >= u"aaa", System.fqdn <= u"zzz")
        )
        clause = lucene_to_sqlalchemy(
            u"fqdn:[aaa TO *]", {"fqdn": System.fqdn}, [System.fqdn]
        )
        self.assert_clause_equals(clause, and_(System.fqdn >= u"aaa", true()))
        clause = lucene_to_sqlalchemy(
            u"fqdn:[* TO zzz]", {"fqdn": System.fqdn}, [System.fqdn]
        )
        self.assert_clause_equals(clause, and_(true(), System.fqdn <= u"zzz"))
        clause = lucene_to_sqlalchemy(
            u"fqdn:[* TO *]", {"fqdn": System.fqdn}, [System.fqdn]
        )
        self.assert_clause_equals(clause, and_(true(), true()))
    ...
    def test_unterminated_range(self):
        clause = lucene_to_sqlalchemy(
            u"[what?", {"user_name": User.user_name}, [User.user_name]
        )
        self.assert_clause_equals(clause, User.user_name == u"[what?")
        clause = lucene_to_sqlalchemy(
            u"user_name:[what?", {"user_name": User.user_name}, [User.user_name]
        )
        self.assert_clause_equals(clause, User.user_name == u"[what?")
    ...
    def test_malformed_range(self):
        ...
        self.assert_clause_equals(clause, or_(System.fqdn == u"[what]", false()))
        clause = lucene_to_sqlalchemy(
            u"memory:[1024, 2048]",
            {"fqdn": System.fqdn, "memory": System.memory},
            [System.fqdn, System.memory],
    ...
    def test_empty_term(self):
        clause = lucene_to_sqlalchemy(u'fqdn:""', {"fqdn": System.fqdn}, [System.fqdn])
        self.assert_clause_equals(clause, System.fqdn == u"")

    def test_any_value(self):
        clause = lucene_to_sqlalchemy(
            u"user:*", {"user": User.user_name}, [User.user_name]
        )
    ...
    def test_collection_relationship(self):
        clause = lucene_to_sqlalchemy(
            u"device.driver:e1000",
            {"fqdn": System.fqdn, "device.driver": (System.devices, Device.driver)},
            [System.fqdn],
        )
        self.assert_clause_equals(clause, System.devices.any(Device.driver == u"e1000"))
