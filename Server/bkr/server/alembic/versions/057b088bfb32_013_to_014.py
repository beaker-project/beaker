...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            "user_id",
            sa.Integer,
            sa.ForeignKey("tg_user.user_id", name="tg_user_id_fk1"),
            nullable=False,
        ),
        sa.Column(
            "delegate_id",
            sa.Integer,
            sa.ForeignKey("tg_user.user_id", name="tg_user_id_fk2"),
            nullable=False,
        ),
    ...
    op.create_table(
        "user_activity",
        sa.Column("id", sa.Integer, sa.ForeignKey("activity.id"), primary_key=True),
        sa.Column(
