-- Total number of install failures (rebooted but did not finish installing)
-- for each unique resource, apart from
-- Virt and Guest resources which are counted in their totality
-- as individually they are not a unique, trackable entity
