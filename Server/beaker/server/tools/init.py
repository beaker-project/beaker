...
def main():
    ...
    #Setup ActionReturn Table
    if ReturnAction.query().count() == 0:
        poweroff    = ReturnAction(u'PowerOff')
        leaveon     = ReturnAction(u'LeaveOn')
        reprovision = ReturnAction(u'ReProvision')
