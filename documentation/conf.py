...
man_pages = [
    (
        ...
        "bkr",
        "Beaker client",
        [u"The Beaker team <beaker-devel@lists.fedorahosted.org>"],
        1,
    ),
    (
        "man/bkr-workflow-xslt",
        "bkr-workflow-xslt",
        "XSLT-based Beaker job generator",
        [u"David Sommerseth <davids@redhat.com>"],
        1,
    ),
]
man_server_pages = [
    (
        ...
        "Generate Anaconda kickstarts",
        [u"The Beaker team <beaker-devel@lists.fedorahosted.org>"],
        8,
    ),
    (
        "admin-guide/man/beaker-create-ipxe-image",
    ...
    (
        "admin-guide/man/beaker-repo-update",
        "beaker-repo-update",
    ...
    (
        "admin-guide/man/beaker-usage-reminder",
...
def strip_decorator_args(app, what, name, obj, options, signature, return_annotation):
    ...
    if what in ("function", "method"):
        ...
        fixed_args = [
            arg
            for arg in args
            if arg not in ("*_decorator__varargs", "**_decorator__kwargs")
        ]
...
def generate_subcommand_list(app):
    ...
    with open(subcommands_path, "w") as command_file:
        ...
        command_file.write(
            ".. This file is autogenerated with commands found"
            " in bkr.client.commands\n\n"
        )
        command_file.write("Subcommands\n***********\n\n")
        # Sort by command name
        subcommand_list = sorted(
            subcommand_list, key=lambda subcommand_list_entry: subcommand_list_entry[0]
        )
